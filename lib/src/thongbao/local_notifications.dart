...
// initialize the local notifications
  ...
  static Future Thongbaosau1phut({
    required String title,
    required String body,
    required String payload,
  ...
  static Future Thongbaosau1ngay({
    required String title,
    required String body,
    required String payload,
  ...
  static Future thongbaosaukhichongio({
    required String title,
    required String body,
    required String payload,
    required int time,
    ...
    await _flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      title,
      body,
      tz.TZDateTime.now(location).add( Duration(seconds: time)),
